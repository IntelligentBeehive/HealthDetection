...
#Modified Sieuwe Eferink 2019
#Made main into function cakked ckassify which returns a list with tuples (label,precistion)
...
def Classify(file_name):
  ...
  for i in top_k:
    resultList.append((labels[i], results[i]))
